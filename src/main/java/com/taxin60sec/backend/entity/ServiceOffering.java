...
public class ServiceOffering extends BaseEntity {
    ...
    // V1.0 spec, "Smart Price Estimate" screen: Complexity (Simple/Moderate/Complex) and
    // the "What's Included" checklist (e.g. "Filing", "Verification", "Expert Support").
    @Column(length = 20)
    private String complexity;

    /** One included item per line, same convention as intakeQuestions above. */
    @Column(length = 2000)
