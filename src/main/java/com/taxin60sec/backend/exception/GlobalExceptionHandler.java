...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleNotFound(NoResourceFoundException exception, HttpServletRequest request) {
        ErrorDetail error = new ErrorDetail(ApiErrorCode.NOT_FOUND.name(), null, "Resource not found");
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(ApiResponse.error("Not found", List.of(error), request.getRequestURI()));
    }
