...
Optional<UploadedDocument> findTopByTaxCaseIdAndDocumentTypeAndDeletedFalseOrderByVersionNumberDesc(
        Long caseId,
        String documentType
);

List<UploadedDocument> findByTaxCase_Client_IdAndDeletedFalseOrderByCreatedAtDesc(
        Long clientId
);
