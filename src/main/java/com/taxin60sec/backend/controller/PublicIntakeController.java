...
public ApiResponse<com.taxin60sec.backend.dto.publicintake.SubmitCaseResponse> submit(

        @PathVariable Long caseId

) {

    com.taxin60sec.backend.dto.publicintake.SubmitCaseResponse response = service.submitCase(caseId);
